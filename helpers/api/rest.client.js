...
const log = require('../common/logger')({name: 'Rest Client'});
...
async function sendRequest(host, method, {path, headers = {'Content-Type': 'application/json'}, withAuth, body, queries} = {}) {
